...
if menu == "Dashboard":
    ...
    with st.spinner("Fetching live geospatial data..."):
        try:
            ...
            with col3:
                st.metric(label="BioNode AI Status", value="Local Active", delta="Ollama Llama 3")
...
# ৩. এআই অ্যালার্ট পেজ (Ollama Local version)
elif menu == "AI Alerts":
    st.title("🤖 BioNode AI - Predictive Outbreak Intelligence")
    st.markdown("---")
    st.info("🧠 Performing climate-informed predictive outbreak modeling and clinical triage locally using Ollama...")
